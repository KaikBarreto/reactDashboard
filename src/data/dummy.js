...
export const kanbanGrid = [
  { headerText: "A fazer", keyField: "Open", allowToggle: true },

  { headerText: "Em Progresso", keyField: "InProgress", allowToggle: true },
  ...
  { headerText: "Concluído", keyField: "Close", allowToggle: true },
]
...
export const EditorData = () => (
  <div>
    <h3>
      ...
      nam rerum harum rem fuga enim aspernatur, debitis quos assumenda possimus
      est id eligendi distinctio suscipit beatae corrupti voluptates. Tenetur?
      Voluptates ullam, officiis minus distinctio a nulla exercitationem
      ratione, animi, harum repellat maxime quasi. Nisi provident ullam, est ab
      aspernatur blanditiis exercitationem quam, velit porro, enim numquam modi
      unde totam. Aliquid distinctio harum in quia, autem sint numquam
      recusandae voluptatibus saepe excepturi dignissimos blanditiis, hic omnis
      quos reiciendis perspiciatis voluptate consequatur rem incidunt repellat.
      Dignissimos autem expedita commodi quas sequi!
    </h3>
  </div>
)
...
export const chatData = [
  {
    image: avatar2,
    message: "Roman entrou na equipe",
    desc: "Parabenize ele",
    time: "9:08 AM",
  },
  {
    ...
    desc: "Samuel te mandou uma mensagem",
    time: "11:56 AM",
  },
  {
    image: avatar4,
    message: "Novo pagamento recebido.",
    desc: "Cheque seus rendimentos",
    time: "4:39 AM",
  },
  {
    image: avatar,
    message: "Jolly completou as tarefas ",
    desc: "Delegue a ele novas tarefas",
    time: "1:12 AM",
  },
]
...
export const recentTransactions = [
  {
    ...
    amount: "+$350",
    title: "Transferência via PayPal",
    desc: "Valor acrescido",
    iconColor: "#03C9D7",
    iconBg: "#E5FAFB",
    pcColor: "green-600",
  },
...
export const weeklyStats = [
  {
    icon: <FiShoppingCart />,
    amount: "-$560",
    title: "Maior quantidade de vendas",
    desc: "Unidade de São Paulo",
    iconBg: "#FB9678",
    pcColor: "red-600",
  },
  {
  ...
  },
  {
    ...
    desc: "Nova aplicação de Kaik Barreto",
    iconBg: "#00C292",
    pcColor: "green-600",
  },
]
...
export const kanbanData = [
  {
    Id: "Parallax Dashboard",
    Title: "Parallax Dashboard",
    Status: "Open",
    Summary:
      "Terminar o projeto de dashboard com React, Syncfusion e TailwindCSS",
    Type: "Story",
    Priority: "Low",
    Tags: "Analyze,Customer",
    Estimate: 3.5,
    Assignee: "Kaik Barreto",
    RankId: 1,
    Color: "#02897B",
  ...
  },
  {
    ...
    Title: "The best dev",
    Status: "Open",
    Summary: "Me tornar o melhor desenvolvedor na minha área",
    Type: "Story",
    Priority: "Alta",
    Tags: "Sucesso, dev",
    Estimate: 3.5,
...
export const PyramidData = [
  { x: "Açúcares e doces", y: 120, text: "120 cal" },
  { x: "Leite, queijo", y: 435, text: "435 cal" },
  { x: "Vegetais", y: 470, text: "470 cal" },
  { x: "Carne, Peixes", y: 475, text: "475 cal" },
